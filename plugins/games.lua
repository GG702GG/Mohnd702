...
if msg.text == redis:get(max..':Fan_nan:'..msg.chat_id_) then -- // اسماء فنانين
redis:incrby(max..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(max..':Fan_nan:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• كفو عليك اعطوه نقطه   \n*   \n')
end

if msg.text == redis:get(max..':Fan_nan:'..msg.chat_id_) then -- // فنان
redis:incrby(max..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(max..':Fan_nan:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• كفو عليك اعطوه نقطه   \n*   \n')
end

if msg.text == redis:get(max..':alm_dol:'..msg.chat_id_) then -- // علم الدوا
redis:incrby(max..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(max..':alm_dol:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• كفو عليك اعطوه نقطه   \n*   \n')
end

if msg.text == redis:get(max..':alm_dol:'..msg.chat_id_) then -- // دول
redis:incrby(max..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(max..':alm_dol:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• كفو عليك اعطوه نقطه   \n*   \n')
end
